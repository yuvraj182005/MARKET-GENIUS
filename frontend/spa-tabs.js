...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const sections = {
    ...
    'investment-analysis': document.getElementById('investment-analysis'),
    'market-news': document.getElementById('market-news'),
    'angel-one': document.getElementById('angel-one')
  };
  ...
  function showSection(name, replaceHash = true) {
    ...
    // Load data when switching to investment-analysis tab
    if (name === 'investment-analysis' && typeof window.loadInvestmentAnalysisData === 'function') {
      window.loadInvestmentAnalysisData();
    }
