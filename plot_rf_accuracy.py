...
def train_and_plot_rf_model():
    """Train Random Forest model for NIFTY and plot accuracy."""
    global models

    print("\n" + "="*60)
    print("Training Random Forest model for NIFTY and plotting accuracy...")
    print("="*60)
    ...
    try:
        ...
        print(f"  [OK] Trained {symbol} Random Forest Model:")
        ...
        # Create the plot
        accuracies = [rf_train_accuracy * 100, rf_test_accuracy * 100]
        ...
        plt.title(f'Random Forest Model Accuracy for {symbol}', fontsize=16, fontweight='bold')
        ...
        # Save the plot
        plot_path = f'rf_accuracy_{symbol.lower()}.png'
        ...
        print(f"\n{'='*60}")
        print(f"RANDOM FOREST MODEL ACCURACY SUMMARY")
        print(f"{'='*60}")
        print(f"Symbol: {symbol}")
        print(f"Test Accuracy: {rf_test_accuracy:.4f} ({rf_test_accuracy*100:.2f}%)")
        print(f"Train Accuracy: {rf_train_accuracy:.4f} ({rf_train_accuracy*100:.2f}%)")
        print(f"{'='*60}")
